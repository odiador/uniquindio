...
public abstract class ParteSuperior extends JFrame implements MouseListener, MouseMotionListener, KeyListener {
	...
	public ParteSuperior() {
		...
		getbNavegacion().setBounds(getBounds().width, getBounds().height, 0, 0);
		getbNavegacion().addKeyListener(this);
		getbNavegacion().addMouseListener(this);
		getbNavegacion().setFocusTraversalKeysEnabled(false);
		panelSuperior.add(getbNavegacion());
	...
	public void agregar(Component c, Object constraints) {
		contentPane.add(c, constraints);
	}

	public JButton getbNavegacion() {
		return bNavegacion;
	}
