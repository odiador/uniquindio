...
public abstract class Template extends JFrame implements ClicListener, MouseMotionListener, MouseListener, KeyListener {
	...
	public Template() {
		...
		UIManager.put("ToolTip.background", Constants.defaultBgColor);
		UIManager.put("ToolTip.foreground", Constants.defaultTextColor);
		UIManager.put("ToolTip.font", Constants.defaultFont);
	}
	...
	public Component addToBody (Component c) {
		return getPanelBody().add(c);
	}

	public void addToBody (Component c, Object constraints) {
		getPanelBody().add(c, constraints);
	}

	public void addToBody (Component c, Object constraints, int index) {
		getPanelBody().add(c, constraints, index);
	}

	public Component addToBody (Component c, int index) {
		return getPanelBody().add(c, index);
	}

	public void addToBody (PopupMenu popUp) {
		getPanelBody().add(popUp);
	}

	public Component addToBody (String name, Component c) {
